...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Owner owner = new Owner("abbas","izmir","+905459149870","abbas@gmail.com","abbas","123456",Arrays.asList(new Role("ROLE_USER")));
        Owner owner2 = new Owner("admin","izmir","+905459149870","admin@gmail.com","admin","123456",Arrays.asList(new Role("ROLE_USER")));
        Owner owner3 = new Owner("qorya","izmir","+905459149870","qorya@gmail.com","qorya","123456",Arrays.asList(new Role("ROLE_USER")));
